...
const about_content = {
  ...
  sub_title: "Unlock Real-Time Insights for Enhanced Social Media Marketing 🚀",
  des: (
    <>
      Unlock the power of real-time data solutions for your social media
      marketing strategy!
    </>
  ),
  ...
  about_list: [
    ...
    <> Experienced Supportive Members.</>,
  ],
  btn_text: "About Us",
};
              ...
              <div className="tp-about__right">
                ...
                <div className="tp-about__btn">
                  <Link
                    ...
                    href="https://genesisvirtue.com/about.html"
                  >
                    <span>{btn_text}</span>
                    <b></b>
                  </Link>
