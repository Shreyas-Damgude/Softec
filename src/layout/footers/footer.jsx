...
const footer_content = {
  ...
  phone: "+91 7706030003",
  contact_mail: "contact@genesisvirtue.com",
  location1: "Germany - Langer Weg 19 60489 Frankfurt am Main",
  location2:
    "India - D-085, D Block, Sector 63, Noida, Hazratpur Wajidpur, Uttar Pradesh 201301",
  ...
  footer_lisks: [
    ...
    },
    {
      ...
      delay: ".9s",
      links: [
        { name: "About", link: "https://genesisvirtue.com/about.html" },
        {
          name: "Services",
          link: "https://genesisvirtue.com/seo_services.html",
        },
        { name: "How It Works", link: "#" },
        { name: "Pricing Plan", link: "#" },
        { name: "Blog", link: "#" },
        { name: "Contact", link: "https://genesisvirtue.com/contact.html" },
      ],
    },
  ],
};
                      ...
                      <div className="tp-footer__contact-info tp-footer__icon-space">
                        <ul>
                          ...
                          <li>
                            ...
                            <Link
                              href="https://maps.app.goo.gl/6rCEQS6k7w6F6pvdA"
                              target="_blank"
                            >
                              {location1}
                            </Link>
                          ...
                          <li>
                            ...
                            <Link
                              href="https://maps.app.goo.gl/HavH4DRA8MPdWwHx7"
                              target="_blank"
                            >
                              {location2}
                            </Link>
