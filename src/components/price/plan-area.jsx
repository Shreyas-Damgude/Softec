...
const plan_content = {
  ...
  tp_des: (
    <>
      Comparing our pricing plans side-by-side so you can choose the best <br />{" "}
      one for yourself.
    </>
  ),
  ...
  feature_lists: [
    ...
    },
    {
      ...
      features: [
        <>
          <i className="far fa-times times"></i>
        </>,
        <>
          <i className="far fa-times times"></i>
        </>,
...
const { tp_title, tp_des, feature_title, feature_items, feature_lists } =
  plan_content;
            ...
            <div className="pr-feature-main">
                        ...
                        {feature_items.map((item, i) => (
                          <li key={i}>
                            <div className={`pr-feature-item ${item.cls}`}>
                              <h5>{item.title}</h5>
                              <Link
                                className="tp-btn-service black-bg text-white"
              ...
              <div className="pr-feature-wrapper-2">
                {feature_lists.map((item, i) => (
                  <div
                    key={i}
                    className="row gx-0 align-items-center pr-feature-height"
                  >
                    <div className="col-xl-4 col-lg-4 col-md-4">
