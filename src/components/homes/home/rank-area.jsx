...
const rank_content = {
  ...
  link: "https://dermahealshop.link/",
};
const { sub_title, title, btn_text, link } = rank_content;
const RankArea = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-5 col-lg-5 order-1 order-lg-1">
              <div
                className="tp-rank__section-box pb-25 wow tpfadeUp"
              ...
              <div
                className="tp-rank__btn wow tpfadeUp"
                data-wow-duration=".9s"
                data-wow-delay=".5s"
              >
                <Link
              ...
              <div className="tp-rank__wrapper p-relative">
                ...
                >
                  {rank_data.map((item, i) => (
                    <div
                      key={i}
                      className={`tp-rank__item p-relative ${item.clg_1}`}
                    >
                      {item.top_img && (
                        <div className="tp-rank__cup">
                          <span>
                            <Image src={item.top_img} alt="" />
                          </span>
                        </div>
                      )}
