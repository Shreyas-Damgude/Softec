...
const service_data = [
  // for home 01
  {
    ...
    description: (
      <>
        Genesis Virtue provides engaging, online attention-grabbing Content
        across all social media platforms to reach your target customers.
      </>
    ),
    delay: ".4s",
    link: "https://genesisvirtue.com/Social_Media.html",
  },
  {
    id: 2,
    icon: img_2,
    ...
    description: (
      <>
        Genesis Virtue produces its own post content that is both appealing &
        user-friendly. We understand that the purpose is to transform your loyal
        followers into recurring paying customers.
      </>
    ),
    delay: ".6s",
    link: "https://genesisvirtue.com/social_media_management.html",
  },
  {
    id: 3,
    icon: img_3,
    ...
    description: (
      <>
        When it comes to Social Media, the visual effect and design across a
        business's social media platforms capture the audience to invite the
        audience to engage with the business immediately. Digital Marketing
        agencies offer skilled and professional Social Media Design strategists
        and graphic artists to create social media visual content.
      </>
    ),
    delay: ".7s",
    link: "https://genesisvirtue.com/social_media_design.html",
  },
  {
    id: 4,
    icon: img_4,
    ...
    description: (
      <>
        Quality marketing content is the way a company brands itself to maintain
        communication and engagement with clientele. A Content Marketing
        Strategy is a thoroughly developed plan of valuable content scheduled
        for distribution as part of a business's campaign to promote its brand
        to make a profit.
      </>
    ),
    delay: ".8s",
    link: "https://genesisvirtue.com/content_marketing.html",
  },
  {
    id: 5,
    icon: img_5,
    ...
    delay: ".9s",
    link: "https://genesisvirtue.com/digital_marketing.html",
  },
